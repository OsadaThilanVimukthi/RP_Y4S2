...
import 'package:projectcucumber/screen/home/pestsSeperate/pestsSeperate.dart';

// A StatelessWidget for a custom button that navigates to the PricePredictorScreen.
class PestsPedict extends StatelessWidget {
  // Constructor for priceButton
  PestsPedict({Key? key}) : super(key: key);
      ...
      child: ElevatedButton(
        onPressed: () {
          Navigator.of(context).push(
            MaterialPageRoute(builder: (context) => pestsSeperate()),
          );
        },
        child: Text('Fruit Pests Analysis',
