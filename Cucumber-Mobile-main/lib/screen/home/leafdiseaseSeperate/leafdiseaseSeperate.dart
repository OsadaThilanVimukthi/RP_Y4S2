...
class leafdiseaseSeperate extends StatefulWidget {
  @override
  _leafdiseaseSeperateState createState() => _leafdiseaseSeperateState();
}

// The state class for Leaf, managing the leaf disease analysis process.
class _leafdiseaseSeperateState extends State<leafdiseaseSeperate> {
  ...
  Widget _buildRecommendationItem(String recommendation, int index) {
    return Card(
      ...
      child: ListTile(
        ...
        trailing: Icon(FontAwesomeIcons.bugs, color: Colors.green[600]),
      ),
    );
  }
